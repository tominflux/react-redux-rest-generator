const doKeysMatch: <T>(resourceA: T, resourceB: T, keyNames: Array<string>) => boolean = (
    resourceA,
    resourceB,
    keyNames
) =>
    keyNames
        ...
        .reduce(
            (doPreviousAllMatch, doesCurrentMatch) => doPreviousAllMatch && doesCurrentMatch,
            true
        )
